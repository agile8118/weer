# Understanding Deployment: Core Concepts — Free Preview Resources

This document contains all the links, commands, and config snippets referenced in the free 2-hour YouTube preview of the **Understanding Deployment: Core Concepts** course.
